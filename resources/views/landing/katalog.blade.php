...
<body class="bg-gray-50 text-gray-800 antialiased">
    ...
    <header class="bg-gradient-to-r from-green-900 to-green-700 text-white shadow-lg sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-6 text-base items-center font-medium">
                ...
                <a href="/katalog" class="hover:text-yellow-300 transition duration-300 ease-in-out transform hover:scale-105 text-yellow-300 font-bold">Katalog Buku</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-green-800 px-4 pt-2 pb-4 rounded-b-lg shadow-inner">
            <nav class="space-y-3 text-base font-medium">
                ...
                <a href="/katalog" class="block py-2 px-3 rounded-md text-yellow-300 font-bold hover:bg-green-700 transition duration-200">Katalog Buku</a>
    ...
    <section class="relative bg-gradient-to-br from-green-800 to-green-600 text-white py-16 md:py-20 overflow-hidden">
        <div class="max-w-7xl mx-auto text-center relative z-10 px-4">
            <h1 data-aos="zoom-in" data-aos-duration="1200" class="text-3xl md:text-5xl font-extrabold mb-4 leading-tight drop-shadow-lg">
                Katalog Buku <span class="text-yellow-300">Perpustakaan Daerah</span> Mandailing Natal
            </h1>
            <p data-aos="fade-up" data-aos-delay="300" class="text-base md:text-lg max-w-3xl mx-auto mb-6 opacity-90">
                Jelajahi koleksi lengkap kami dan temukan sumber pengetahuan yang Anda cari.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 px-4 bg-gray-50">
        <div class="max-w-7xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-green-900 mb-12" data-aos="fade-down">Daftar Buku Tersedia</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @forelse ($books as $index => $book)
                    <div data-aos="fade-up" data-aos-delay="{{ $index * 100 }}"
                        class="bg-white border border-gray-200 shadow-xl rounded-2xl overflow-hidden flex flex-col transition-transform hover:shadow-2xl hover:-translate-y-2 duration-300">
                        ...
                        <div class="p-4 flex flex-col flex-1">
                            <h3 class="font-bold text-xl text-green-800 mb-1">{{ $book->judul_buku }}</h3>
                            <p class="text-base text-gray-700 mb-1">Penulis: {{ $book->penulis }}</p>
                            <p class="text-sm text-gray-500 mt-1 mb-4">Kategori: {{ $book->category->nama_kategori ?? 'Umum' }}</p>

                            <div class="mt-auto">
                                <a href="/login"
                                    class="inline-flex items-center justify-center w-full text-center bg-yellow-400 text-green-900 font-semibold py-3 rounded-lg shadow-md hover:bg-yellow-500 transition-colors duration-200 text-base transform hover:scale-105">
                                    Ajukan Peminjaman
                ...
                @empty
                    <p class="col-span-full text-center text-gray-500 text-lg py-10">Belum ada buku yang tersedia untuk ditampilkan.</p>
                @endforelse
            </div>
        </div>
    </section>
